...
class ItemEquipment with _$ItemEquipment {
  const factory ItemEquipment({
    ...
    @JsonKey(name: 'preset_no', fromJson: stringToConvertInt) @Default(0) int presetNo,
...
class ItemEquipmentElement with _$ItemEquipmentElement {
  const factory ItemEquipmentElement({
    ...
    @JsonKey(name: 'item_total_option') required ItemTotalOption itemTotalOption,
    @JsonKey(name: 'item_base_option') required ItemBaseOption itemBaseOption,
    ...
    @JsonKey(name: 'item_exceptional_option') required ItemExceptionalOption itemExceptionalOption,
    @JsonKey(name: 'item_add_option') required ItemAddOption itemAddOption,
    ...
    @JsonKey(name: 'item_etc_option') required ItemEtcOption itemEtcOption,
    @JsonKey(name: 'starforce', fromJson: stringToConvertInt) @Default(0) int starforce,
