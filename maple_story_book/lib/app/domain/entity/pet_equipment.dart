...
class PetEquipment with _$PetEquipment {
  const factory PetEquipment({
    ...
    @JsonKey(name: 'pet_1_equipment') PetEquipmentElement? petFirstEquipment,
    @JsonKey(name: 'pet_1_auto_skill') AutoSkillElement? petFirstAutoSkill,
    ...
    @JsonKey(name: 'pet_2_equipment') PetEquipmentElement? petSecondEquipment,
    @JsonKey(name: 'pet_2_auto_skill') AutoSkillElement? petSecondAutoSkill,
    ...
    @JsonKey(name: 'pet_3_equipment') PetEquipmentElement? petThirdEquipment,
    @JsonKey(name: 'pet_3_auto_skill') AutoSkillElement? petThirdAutoSkill,
...
class PetEquipmentElement with _$PetEquipmentElement {
  const factory PetEquipmentElement({
    ...
    @JsonKey(name: 'scroll_upgrade') @Default(0) int scrollUpgrade,
    @JsonKey(name: 'scroll_upgradable') @Default(0) int scrollUpgradable,
